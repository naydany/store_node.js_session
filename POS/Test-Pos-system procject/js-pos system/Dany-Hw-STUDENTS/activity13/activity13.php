...
<body>
    ...
    ?>
        ...
        <div class="card-img">
        <img
        src= <?php echo $posts[$i]['image'] ?> >
      </div>
      <div class="card-body">
        <h2 class="card-title"> <?php echo $posts[$i]['title']  ?> </h2>
        <p class="description">
        <?php echo $posts[$i]['description']  ?>
        </p>
      </div>
      <div class="card-footer">
        <span class="date"><?php echo $posts[$i]['date']  ?></span>
        <span class="author"><?php echo $posts[$i]['author']  ?></span>
      </div>
